package com.fortheadvancementoflearning.blog.controllers;
...
import com.fortheadvancementoflearning.blog.services.FileService;
import com.fortheadvancementoflearning.blog.services.PostService;
...
//	create
	...
	public ResponseEntity<List<PostDto>> searchPostByTitle(@PathVariable("keywords") String keywords) {
		List<PostDto> result = this.postService.getPostByKeyword(keywords);
